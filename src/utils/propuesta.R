propuesta <- function(tabla_mortalidad, x, r, e, tc, Sm, S, n, h) {
  ...
  tr_ai <- if(S_ai == 0){
    ...
    ahorro_individual(tabla_mortalidad, x, r, e, tc, Sm, S_ai, n)["tr"]
  }
  ...
  # Imprimir resultados
  cat("Mesada total:", m_total, "\n")
  cat("Tasa de reemplazo efectiva:", t_efectiva, "\n")
  cat("Tasa de remplazo en el sistema publico", tr_pm, "\n")
  cat("Tasa de reemplazo en el sistema privado", tr_ai)
  return(c(m_total, t_efectiva))
}